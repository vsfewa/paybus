...
public class NfcUtils {
    ...
    public NfcUtils(Activity activity) {
        Log.e(TAG, "Go into onNewIntent function" );
...
//        }
//        return "";
        String str = intent.getStringExtra("NFC_data");
        Log.e("account","read:  "+str);
        return str;
    }
...
//        ndef.writeNdefMessage(ndefMessage);
        intent.putExtra("NFC_data",data);
        Log.e("account","write:  " + intent.getStringExtra("NFC_data"));
    }
...
//        return id;
        String id = intent.getStringExtra("NFC_id");
        return id;
    }
